...
<div class="widget_shopping_cart_content">
    <?php if ( ! WC()->cart->is_empty() ) : ?>
            ...
            <table class="table offcanvasCart-table woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
                            ...
                            <td>
                                ...
                                echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                    ...
                                    sprintf(
                                        '<a 
                                            href="%s" 
                                            class="remove remove_from_cart_button btn btn-danger" 
                                            aria-label="%s" 
                                            data-product_id="%s" 
                ...
                <tfoot>
                    <tr>
                        <td 
                            colspan="2" 
                            class="text-center woocommerce-mini-cart__total total"
                        >
                            <b>Total:</b>
                        </td>
                        <td 
        ...
        <div class="text-end mt-3 woocommerce-mini-cart__buttons buttons">
            <a href="<?php echo wc_get_cart_url(); ?>" class="btn btn-outline-warning">
            <?php _e( 'Cart', 'eshop' ); ?>
        </a>
            <a href="<?php echo wc_get_checkout_url(); ?>" class="btn btn-outline-secondary">
            <?php _e( 'Checkout', 'eshop' ); ?>
        </a>
        </div>
    ...
    <?php else : ?>
            ...
            <p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'eshop' ); ?></p>
