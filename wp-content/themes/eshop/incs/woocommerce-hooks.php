...
// custom shortcode
add_shortcode( 'eshop_recent_products', 'eshop_recent_products' );
function eshop_recent_products( $atts ) {
...
// отображение картинки категории в архиве категорий
// https://woo.com/document/woocommerce-display-category-image-on-category-archive/

function eshop_get_shop_thumb() {
