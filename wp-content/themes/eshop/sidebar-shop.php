        ...
        <div class="filter-block">
            ...
            <form action="">
                <div class="form-check d-flex justify-content-between">
                    ...
                    <span class="badge border rounded-0">13</span>
                </div>

                <div class="form-check d-flex justify-content-between">
                    <div>
                        <input class="form-check-input" type="checkbox" value="" id="braun">
                        <label class="form-check-label" for="braun">
                            Braun
                        </label>
                    </div>
                ...
                <div class="form-check d-flex justify-content-between">
                    <div>
                        <input class="form-check-input" type="checkbox" value="" id="beige">
                        <label class="form-check-label" for="beige">
                            Beige
                        </label>
                    </div>
                    <span class="badge border rounded-0">2</span>
                </div>
                ...
                <div class="form-check d-flex justify-content-between">
                    ...
                    <span class="badge border rounded-0">53</span>
                </div>
                ...
                <div class="form-check d-flex justify-content-between">
                    ...
                    <span class="badge border rounded-0">5</span>
                </div>

                <div class="form-check d-flex justify-content-between">
                    <div>
                        <input class="form-check-input" type="checkbox" value="" id="bronze">
